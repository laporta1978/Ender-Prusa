...
#define STRING_CONFIG_H_AUTHOR "(Gaston Laporta)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Argento Bear"
...
#define Z_SERVO_ANGLES { 0, 0 } // Z Servo Deploy and Stow angles
